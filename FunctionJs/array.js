...
let student = new Array(10,"Halen");
let teacher = ["king","kingngn","jonh"];

console.log("Array index at array : ",teacher[1]);
...
let products = [
    ...
    {
        title:"IROG 4 Republic of Gamers Global|For Those Who Dare",                                                                                      
        price:200,
        productImages: "474x/0b/16/62/0b166280590ba7550a59a47002aba8f8.jpg"
    }
]
...
products.map( products =>{
    ...
    <a href="#">
        <img class="p-8 rounded-t-lg" src="${baseURL}${products.productImages}" alt="product image" />
    </a>
    <div class="px-5 pb-5">
        <a href="#">
